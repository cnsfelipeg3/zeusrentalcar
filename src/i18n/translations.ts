...
export const translations: Record<Language, TranslationKeys> = {
  ...
  en: {
    ...
    about: {
      ...
      description: "Zeus Rental Car is a reference in premium vehicle rental for Brazilians in Orlando. We offer a high-level mobility experience, with personalized service and a curated fleet to transform your trip.",
      tagline: "Premium mobility for Brazilians in Orlando.",
  ...
  es: {
    ...
    about: {
      title: "Quiénes ",
      titleHighlight: "Somos",
      description: "Zeus Rental Car es referencia en alquiler de vehículos premium para brasileños en Orlando. Ofrecemos una experiencia de movilidad de alto nivel, con atención personalizada y flota seleccionada para transformar su viaje.",
      tagline: "Movilidad premium para brasileños en Orlando.",
  ...
  de: {
    ...
    about: {
      title: "Wer wir ",
      titleHighlight: "sind",
      description: "Zeus Rental Car ist eine Referenz im Premium-Fahrzeugverleih für Brasilianer in Orlando. Wir bieten ein erstklassiges Mobilitätserlebnis mit persönlichem Service und einer ausgewählten Flotte, um Ihre Reise zu verwandeln.",
      tagline: "Premium-Mobilität für Brasilianer in Orlando.",
  ...
  fr: {
    ...
    about: {
      ...
      description: "Zeus Rental Car est une référence en location de véhicules premium pour les Brésiliens à Orlando. Nous offrons une expérience de mobilité haut de gamme, avec un service personnalisé et une flotte sélectionnée pour transformer votre voyage.",
      tagline: "Mobilité premium pour les Brésiliens à Orlando.",
