    ...
    <div className="container mx-auto px-4 max-w-3xl">
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-black uppercase tracking-wider">
          Condições <span className="gold-text">Especiais</span>
        </h2>
        <p className="text-muted-foreground font-light mt-2">
          Condições especiais para sua reserva. Quanto mais dias, maior o desconto.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-8">
          <div className="text-center p-6 rounded-lg bg-muted/50">
            ...
            <p className="text-sm text-muted-foreground mt-2 font-light">2 a 5 dias de locação</p>
          </div>
          <div className="text-center p-6 rounded-lg bg-muted/50">
            <Percent className="text-primary mx-auto mb-3" size={32} />
            <p className="text-3xl font-black gold-text">10% OFF</p>
            <p className="text-sm text-muted-foreground mt-2 font-light">+7 dias de locação</p>
          </div>
        </div>
      </motion.div>
    </div>
